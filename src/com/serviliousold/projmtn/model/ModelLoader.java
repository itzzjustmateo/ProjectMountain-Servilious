...
public class ModelLoader {
    ...
    public static BaseModel loadModel(String modelPath, VertexLoader loader) {
        FileReader fr = null;
        try {
            fr = new FileReader(new File("resources/model/" + modelPath + ".obj"));
        ...
        return loader.sendToVao(verticesArray, texturesArray, normalsArray, indicesArray);
